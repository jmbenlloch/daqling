...
export LD_LIBRARY_PATH=/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_armv8l-linux-gnueabihf/lib/:/usr/local/lib64/:$LD_LIBRARY_PATH
#export PATH=/opt/ohpc/pub/compiler/gcc/8.3.0/bin:$PATH
export PATH=/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_armv8l-linux-gnueabihf/bin:$PATH

# Export package specific environmental variables

export CC='/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_armv8l-linux-gnueabihf/bin/armv8l-linux-gnueabihf-gcc'
export CXX='/opt/toolchains/gcc-linaro-7.5.0-2019.12-x86_64_armv8l-linux-gnueabihf/bin/armv8l-linux-gnueabihf-g++'
