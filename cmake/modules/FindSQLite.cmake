...
find_path(SQLITE_INCLUDE_DIR sqlite3.h HINTS $ENV{SQLITE_ROOT_DIR}/include ${SQLITE_ROOT_DIR}/include)
find_library(SQLITE_LIBRARY NAMES sqlite3 HINTS $ENV{SQLITE_ROOT_DIR}/lib ${SQLITE_ROOT_DIR}/lib )

find_program(SQLITE_EXECUTABLE NAMES sqlite3
             HINTS $ENV{SQLITE_ROOT_DIR}/bin ${SQLITE_ROOT_DIR}/bin )
